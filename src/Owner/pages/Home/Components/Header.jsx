...
<nav className="bg-[#FEFEFE] fixed mb-[74px] top-0 left-0 right-0 shadow w-full border-gray-200 dark:bg-gray-900">
  ...
  <div className="flex items-center md:order-2 relative">
     {
      isAuthenticated && (
      //   <button onClick={()=>setDropdown(!dropdown)} type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
